<script lang="ts">
	...
	import { AppBar, AppShell, Drawer, LightSwitch, Toast, getDrawerStore, initializeStores } from '@skeletonlabs/skeleton';
...
<Drawer position='right' width="w-min">
	<div class="flex flex-col items-end">
		<button on:click={closeDrawer} class="m-4 mb-0">
			<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="h-12 fill-token" viewBox="0 0 24 24">
...
<AppShell>
	...
	<div class="flex md:hidden">
		<SideAd ads={ads} override={true} />
	</div>

	<svelte:fragment slot="pageFooter">
		<div class="flex flex-col justify-center content-center text-center p-5">
			<p class="mb-3">La web TV dell'alto Varesotto</p>
			<h6>Sito web prodotto da <a class="chip variant-soft hover:variant-filled card-hover" href="http://svasso-spensierato.web.app" target="_blank" rel="noopener noreferrer">Andrea Bonari</a></h6>
		</div>
	</svelte:fragment>
</AppShell>
